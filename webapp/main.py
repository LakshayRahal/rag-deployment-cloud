...
# | Component          | Role                                               |
# | ------------------ | -------------------------------------------------- |
# | `os`               | Access secrets from environment variables.         |
# | `openai`           | Call Azure-hosted GPT models.                      |
# | `FastAPI`          | Run a lightweight, modern web server for your API. |
# | `RedirectResponse` | Redirect root URL to `/docs`.                      |
# | `BaseModel`        | Define and validate JSON body of the request.      |
# | `OpenAIEmbeddings` | Convert user queries into vector form.             |
# | `AzureSearch`      | Search your vector index for relevant context.     |
